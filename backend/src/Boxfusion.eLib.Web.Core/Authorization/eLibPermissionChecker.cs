...
namespace Boxfusion.eLib.Common.Authorization
{
    /// <summary>
    /// eLib Permission checker
    /// </summary>
    public class eLibPermissionChecker : ICustomPermissionChecker, IeLibPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public eLibPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
