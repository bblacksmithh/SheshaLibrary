...
using Moq;
using NSubstitute;
using Boxfusion.eLib.Tests.DependencyInjection;
using Shesha;
...
namespace Boxfusion.eLib.Common.Tests
{
    [DependsOn(
        typeof(eLibModule),
    ...
    public class eLibCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public eLibCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
